...
import { toAddressResponse, CreateAddressRequest, AddressResponse, UpdateAddressRequest, GetAddressRequest, RemoveAddressRequest } from "../model/address-model";
...
export class AddressService {
    ...
    static async remove(user: User, request: RemoveAddressRequest): Promise<void> {
