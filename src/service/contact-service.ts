...
export class ContactService {
    ...
    static async update(user: User, request: UpdateContactRequest): Promise<UpdateContactRequest> {
    ...
    static async search(user: User, request: SearchContactRequest): Promise<Pageable<ContactResponse>> {
        const searchRequest = Validation.validate(ContactValidation.FILTER, request)
